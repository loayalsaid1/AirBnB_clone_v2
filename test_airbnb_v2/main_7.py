...
if "[Place]" not in result or place_id not in result:
    print("FAIL:Place wrong output format: \"{}\"".format(result))
    
if "city_id" not in result or city_id not in result:
    print("FAIL:city_id missing new information: \"{}\"".format(result))
    
if "user_id" not in result or user_id not in result:
    print("FAIL: user_idmissing new information: \"{}\"".format(result))
    
if "name" not in result or place_name not in result:
    print("FAIL:name missing new information: \"{}\"".format(result))
    
if "description" not in result or place_desc not in result:
    print("FAIL: descriptionmissing new information: \"{}\"".format(result))
    
if "number_rooms" not in result or str(place_nb_rooms) not in result:
    print("FAIL: number_roomsmissing new information: \"{}\"".format(result))
    
if "number_bathrooms" not in result or str(place_nb_bath) not in result:
    print("FAIL:number_bathroomsmissing new information: \"{}\"".format(result))
    
if "max_guest" not in result or str(place_max_guests) not in result:
    print("FAIL:max_guest missing new information: \"{}\"".format(result))
    
if "price_by_night" not in result or str(place_price) not in result:
    print("FAILprice_by_night: missing new information: \"{}\"".format(result))
    
if "latitude" not in result or str(place_lat) not in result:
    print("FAIL: latitudemissing new information: \"{}\"".format(result))
    
if "longitude" not in result or str(place_lon) not in result:
    print("FAIL:longitude missing new information: \"{}\"".format(result))
